	...
	<div id="page" class="theia-exception">
		...
		<header class="header menu_fixed">
			...
			<ul id="top_menu">
				...
				<li><a href="cart.jsp"><img src="index/img/shopping_button.png" width="24" height="24" class="logo_sticky"></a></li>
				...
				<li><a href="cart.jsp"><img src="index/img/shopping_button1.png" width="24" height="24" class="logo_normal"></a></li>
			...
			<nav id="menu" class="main-menu">
				<ul>
					...
					<li><span><a href="producthot">周边</a></span></li>
