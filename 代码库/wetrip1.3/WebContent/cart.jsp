    ...
    <div class="wrapper">
        <section class="section-head">
            ...
            <ul id="top_menu">
                ...
                <li><a href="login.jsp"><img src="good/images/personal_button1.png" width="24" height="24"></a></li>
            ...
            <ul id="top_menu2">
                ...
                <li><a href="login.jsp"><img src="good/images/personal_button.png" width="24" height="24" ></a></li>
                    ...
                    <div class="span12">
                        <div class="page-content shopping-cart-page ">
                            <table class="table ">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="thumb">
                                                <img alt="" src="good/images/p7.jpg" />
                                            </div>
                                        </td>
                                        <td>
                                            <div class="desc">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="thumb">
                                                <img alt="" src="good/images/p8.jpg" />
                                            </div>
                                        </td>
                                        <td>
                                            <div class="desc">
                            ...
                            <div class="buttons-holder">
                                <a class="cusmo-btn gray narrow" href="part.jsp">继续购物</a>
                                <a class="cusmo-btn narrow" href="checkout-1.jsp">结算</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript" src="good/js/jquery.carouFredSel-6.2.1-packed.js"></script>
