...
<div id="page" class="theia-exception">		
	...
	<main>
		...
		<div id="con_one_1">
        <div id="1">  
       	<form id="form1" name="form1" method="post" action="personalinfo">
        <table width="400" border="0" cellpadding="0" cellspacing="0" align="center" >
		  <tr>
			<td width="142" align="right">邮箱：</td><div id="msg1" align="center" style="color:red"></div>
			<td width="352"><input type="text" style="width:200; height:40" value="${email } " size="30" 
	    ...
	    <tr>	
      	    <td height="30" width="30" >个人说明：</td><td><textarea rows="5" cols="35" name="description">${description }</textarea></td>	             
	    </tr>
       </table>
	  ...
	  <tr>
			...
			<td><input type="password" id="password1" name="password1" size="30"onblur="checkpasswordNull()"  onfocus="xiaoshi2()"/></td>
	  </tr>
	  <tr>
      		<td height="30" align="right">确认密码：</td>
			<td><input type="password" size="30" id="password2" name="password2" onblur="checkpasswordNull()"  onfocus="xiaoshi2()"/></td>
			  <div id="msg2" align="center" style="color:red"></div>
	  </tr>	 
      	</table>
      	</div>
        ...
        <div id="txgg">
        <div id="tx01"><img src="${pageContext.request.contextPath }/${userhead}"/></div>
        <div id="wzms"><span>从电脑中选择你喜欢的图片</span>   <br>  JPG、JPEG、GIF、或PNG等文件.
        <div id="tpsc">
        	<form >
        		<a href="javascript:;" class="file"><input type="file"  name="" >选择文件</a><span class=".fileerrorTip" class=".showFileName"></span>       	
        	<div id="errortip">提示文件过大信息</div>
        	</form>
        </div>
        </div>
        </div>
	...
	<div id="rightContent">
		<div class="sidebar-box bg-box about-me">
					...
					<div style="text-align:center;"><img src="${pageContext.request.contextPath }/${userhead}" alt=""  /></div>
					<h5>${username }
					<c:if test="${sex=='男' }">
