 ...
 */
@Controller
public class EditorUpdateController {
...
//调用service的方法
		TravelNote oldTravelNote=editorServiceImpl.findById(id);
		System.out.println("输出老游记的信息"+oldTravelNote.getTitle());
		this.editorServiceImpl.delTagConnect(oldTravelNote);
		editorServiceImpl.updateTravelNotesAndImages(oldTravelNote,travelNote,imgPaths,id); 
