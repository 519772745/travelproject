...
public class ZoneServiceImpl {
	...
	public List<TravelNote> findTravelByUsername(int pageNum, int pageSize,String username,String loginUsername){
		List<TravelNote>  list= new ArrayList<TravelNote>();
		if(username.equals(loginUsername)) {
			list=this.zoneDaoImpl.findTravelByLoginUsername(pageNum, pageSize, loginUsername);
		}
		else {
			list= this.zoneDaoImpl.findTravelByUsername(pageNum, pageSize, username);
		}
		return list;
	}
