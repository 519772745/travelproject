	        ...
	        <div id="txgg">
		        ...
		        <div id="wzms">
		        	<span>从电脑中选择你喜欢的图片</span> <br>  JPG、JPEG、GIF、或PNG等文件。
			        	<div id="tpsc">
				        	<form action="personalImg" method="post" enctype="multipart/form-data">
				        		<a href="javascript:;" class="file"><input type="file"  name="upfile" >选择文件</a>
				        		<input type="submit" value="上传" id="upbtn" class="button"/>       	
